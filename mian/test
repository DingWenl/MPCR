...
if __name__ == '__main__':
    ...
    t_test_list = [1.0] # [0.5,0.6,0.7,0.8,0.9,1.0,1.1,1.2]
    for sub_selelct in range(1, 36):
        ...
        for t_test in t_test_list:
            ...
            for block_n in range(5, 6):
                ...
                model_path = '/data/dwl/ssvep/model/benchmark_test/cnnformer_crossblock_test/cnnformer_%3.1fs_%d_block%d.h5'%(t_test, sub_selelct,block_n)

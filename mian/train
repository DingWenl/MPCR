    ...
    for sub_selelct in range(1, 36):
        ...
        for t_train in t_train_list:
            ...
            for block_n in range(5, 6):
                ...
                train_gen = data_generator.train_datagenerator(batchsize,data1, data2, data3,win_train,train_list, channel)#, t_train)
                ...
                model_path = '/data/dwl/ssvep/model/benchmark_test/cnnformer_crossblock_test/cnnformer_%3.1fs_%d_block%d.h5'%(t_train, sub_selelct,block_n)
